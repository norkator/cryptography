 ...
 * questions.
 */
package cryptography.padding.pkcs5;
...
public interface Padding {
	 ...
	 * @param off the offset in <code>in where the padding bytes
	 *            are appended
	 * @param len the number of padding bytes to add
	 * @throws ShortBufferException if <code>in is too small to hold
	 *                              the padding bytes
	 */
	 ...
	 * @param off the offset in <code>in where the data starts
