...
public class Ciphers { 
	...
	public static void main(String[] args) {
		...
		// Adfgvx
		System.out.println("Adfgvx encrypt: " + Adfgvx.adfgvx("HELLOWORLD", "abcdef", Mode.ENCRYPT));
		System.out.println("Adfgvx decrypt: " + Adfgvx.adfgvx("DDFADXFGAFFVFXDGDXVX", "abcdef", Mode.DECRYPT));
